...
{
  if (pMiner->IsFighting()) {
    cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "Round one!";
  } else {
  ...
  switch (msg.Msg)
  {
    case Msg_Insult:
      Dispatch->DispatchMessage(SEND_MSG_IMMEDIATELY,
                                ...
                                Msg_ReplyInsult,
                                NULL);
      cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "I am gonna destroy you";
      pMiner->Fighting(true);
...
void Fight::Execute(Miner* miner) {
  ...
  if (miner->Fatigued()) {
      cout << endl << GetNameOfEntity(miner->ID()) << ": It's enough... I win!!";
      Dispatch->DispatchMessage(SEND_MSG_IMMEDIATELY,
                                miner->ID(),
                                ent_Bar_Fly,
                                Msg_FinishFight,
      ...
      cout << endl << GetNameOfEntity(miner->ID()) << ": You are bleeding!";
  }
}
